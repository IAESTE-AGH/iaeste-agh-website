...
export const ui = {
    pl: {
        ...
        'footer.board.president.email': 'karolina.mleko@iaeste.pl',
        'footer.board.president.name': 'Karolina Mleko',
        'footer.board.treasurer.title': 'Skarbnik',
        'footer.board.treasurer.email': 'ewa.lewandowska@iaeste.pl',
        'footer.board.treasurer.name': 'Ewa Lewandowska',
        'footer.board.vicepresident.title': 'Wiceprezes',
        'footer.board.vicepresident.email': 'mateusz.wilk@iaeste.pl',
        'footer.board.vicepresident.name': 'Mateusz Wilk',
